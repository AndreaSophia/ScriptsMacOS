# Meridian 1.1 Remedy RC1 — prueba controlada en Mac corporativo
...
pkgutil --payload-files Meridian/dist/Meridian-1.1.0-remedy-rc1.pkg | grep -E '(^|/)\._|(^|/)\.DS_Store$'
shasum -a 256 Meridian/dist/Meridian-1.1.0-remedy-rc1.pkg
```
...
```bash
PKG="$HOME/Downloads/Meridian-1.1.0-remedy-rc1.pkg"
shasum -a 256 "$PKG"
...
`1.1.0-remedy-rc1` y ayuda funcional.
...
## 5. Consultas manuales read-only para contraste
...
- instalación correcta y versión RC1 confirmada;
